			...
			<div class="row">
				<div class="content-column col-xl-6 col-lg-7 col-md-12 col-sm-12 order-2 wow fadeInRight"
					...
					<div class="inner-column">
						...
						<div class="btn-box">
							<a  class="theme-btn btn-style-one"><span class="btn-title">Explore now</span></a>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="contact-info-block-two col-lg-6 col-md-12">
					<div class="inner-box">
						...
						<a href="contact" class="theme-btn btn-style-one light"><span class="btn-title">Free consultation</span></a>
					</div>
				</div>
