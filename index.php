...
.header-style-three {
  position: absolute;
				...
				<div class="content-column col-xl-5 col-lg-6 col-md-12">
					<div class="inner-column wow fadeInRight">
						<div class="sec-title">
							...
							<h2>We have best designers & developers</h2>
						</div>
						...
						<div class="feature-block">
							<div class="inner-box">
								<div class="content">
									...
									<h5 class="title">Seamless User Experience</h5>
									<div class="text">We design intuitive and engaging interfaces that make navigation effortless and enjoyable for your users. Every click, swipe, and interaction feels smooth and meaningful.</div>
								</div>
							</div>
						</div>
						...
						<div class="feature-block">
							<div class="inner-box">
								<div class="content">
									<span class="icon"><i class="fa fa-check"></i></span>
									<h5 class="title">Agile Development Process</h5>
									<div class="text">Our smart and flexible development approach ensures faster delivery, high-quality coding, and scalable solutions tailored to your business needs.</div>
								</div>
							</div>
						</div>
						...
						<div class="feature-block">
							<div class="inner-box">
								<div class="content">
									<span class="icon"><i class="fa fa-check"></i></span>
									<h5 class="title">Creative & Modern Web Design</h5>
									<div class="text">Stand out with visually appealing, responsive, and user-friendly designs that leave a lasting impression and keep your audience connected.</div>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="auto-container">
			<div class="upper-box">
				...
				<div class="text-column">
					<div class="text">We take pride in every project we deliver. With a track record of successfully completed projects across diverse industries, we have helped businesses transform ideas into digital reality. Each project reflects our commitment to quality, innovation, and customer satisfaction.</div>
				</div>
			</div>
				...
				<div class="content-column col-xl-6 col-lg-7 col-md-12 col-sm-12 order-2 wow fadeInRight"
					...
					<div class="inner-column">
						<div class="sec-title">
							...
							<h2>Our Mission</h2>
							<div class="text m--0">To simplify technology and make it accessible, impactful, and result-driven for businesses worldwide.</div>

							<h2 class="mt-20">Our Vision</h2>
							<div class="text m--0">To be recognized as a global leader in web and app development, delivering innovative solutions that shape the digital future.</div>
						...
						<div class="btn-box">
							<a href="page-service-details.html" class="theme-btn btn-style-one"><span class="btn-title">Explore now</span></a>
						</div>
					</div>
				</div>
				...
				<div class="image-column col-xl-6 col-lg-5 col-md-12 col-sm-12">
					<div class="inner-column wow fadeInLeft">
						<div class="image-box">
							...
							<figure class="image-3 overlay-anim wow fadeInRight"><img src="images/resource/benefit-3.jpg" alt=""></figure>
							<figure class="logo"><img src="images/resource/fav-icon.png" alt=""></figure>
						</div>
					</div>
				</div>
			</div>
	...
	<!-- Contact Section -->
	<section class="contact-section pt-0 pb-0 pt-90">
		<div class="auto-container">
			<div class="row">
				<!-- Form Column -->
